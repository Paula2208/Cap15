...
# Fondo
raw_bg = pygame.image.load("images/l6.png").convert()
...
def update(dt, keyboard):
    ...
    if book_already_shown and mode == "surprised":
        ...
        if robot.x < WIDTH + 200:
            ...
            switch_scene(__import__('events.p10_scene7', fromlist=['scene7']))
    ...
    if mode == "walking":
        ...
        if book_zooming_in and time.time() - book_start_time >= 8:
