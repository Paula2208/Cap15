import pgzrun
import pygame
from events import p3_scene2#, p3_scene3, p3_scene4, p3_scene5
...
def draw():
    screen.clear()
    if not started:
        screen.draw.text("Parte 3", center=(WIDTH // 2, HEIGHT // 2 - 400), fontsize=50, color="white")
