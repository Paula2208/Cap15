import pgzrun
import pygame
from events import p7_scene2#, p7_scene2, p7_scene3, p7_scene4, p7_scene5
...
def start_game():
    ...
    p7_scene2.init(switch_scene)
    current_scene = p7_scene2
    started = True
...
def draw():
    screen.clear()
    if not started:
        screen.draw.text("Parte 7: last", center=(WIDTH // 2, HEIGHT // 2 - 400), fontsize=50, color="white")
...
p7_scene2.init(switch_scene)
#p7_scene2.init(switch_scene)
# p7_scene3.init(switch_scene)
# p7_scene4.init(switch_scene)
# p7_scene5.init(switch_scene)
